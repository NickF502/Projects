...
public class RandomForest {
	...
	protected ArrayList<DecisionTree> decisionTreeList;	// Stores decision trees that make up the RF
	...
	public RandomForest(Validation data) {
		...
		this.decisionTreeList = new ArrayList<DecisionTree>();
	...
	private void createTrees(Dataset data) {
		...
		for(int i=0; i<100; i++) {
			...
			this.decisionTreeList.add(tree);
		}
	}
	...
	public int predict(UserData u) {
		...
		for(DecisionTree tree : this.decisionTreeList) {
